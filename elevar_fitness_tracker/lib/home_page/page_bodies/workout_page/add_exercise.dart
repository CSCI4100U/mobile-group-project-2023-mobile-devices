...
class AddExerciseState extends State<AddExercise> {
  ...
  Future<void> init() async { // initial http request on page build
        ...
        children: [
          Padding(
            ...
            child: SizedBox(
              ...
              child: DropdownButtonFormField(
                ...
                items: states.map(
                  (String item) {
                    return DropdownMenuItem(
                      value: item,
                      child: Text(item, style: styles.getSubHeadingStyle(),),
                    );
                  }
                ).toList(),
                onChanged: (value) {
                ...
                icon: Icon(Icons.arrow_drop_down_circle_outlined, color: styles.getObjectColor(),),
                decoration: InputDecoration(
                  labelText: "Select Muscle:",
                  focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: styles.getObjectColor())),
          ...
          Expanded(
            child: ListView.separated(
              ...
              separatorBuilder:(context, index) => Divider(color: styles.getObjectColor(),), 
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  setState(() {
                    selectedExercises.forEach((element) {element.isSelected = false;});
                    selectedExercises = [];
                  });
                },
              ),
  ...
  Widget exerciseTile(String name, String muscle, bool isSelected, int index) {
    return ListTile(
      leading: Icon(Icons.area_chart, color: styles.getHighlightColor(),),
      title: Text(
        name,
      ...
      trailing: isSelected
      ? Icon(Icons.check_box_rounded, color: styles.getHighlightColor(),) 
      : Icon(Icons.check_box_outline_blank_rounded, color: styles.getObjectColor(),),
      onTap: () {
        setState(() {
          ...
          if(exercises[index].isSelected == true) {
            ...
            selectedExercises.removeWhere((element) => element.name == exercises[index].name);
          }
        });
      },
    );
