...
class _AccountBodyState extends State<AccountBody> {
              ...
              MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                            "Updated name to \"${firstNameController.text} ${lastNameController.text}\"")));
                  })
            ],
          );
        });
  ...
  void editBirthdateDialog(
      BuildContext context, String username, Map<String, dynamic> data) async {
    final DateTime? picked = await showDatePicker(
      context: context,
      initialEntryMode: DatePickerEntryMode.calendarOnly,
      initialDate: (data['birthdate'] as Timestamp).toDate(),
    ...
    if (picked != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
              "Updated birthdate to \"${AccountBody.formatTimestamp(Timestamp.fromDate(picked).toDate())}\"")));
    }
  }
              ...
              content: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                          decoration:
                              const InputDecoration(label: Text("New e-mail")),
                          controller: emailController),
                      TextFormField(
                        decoration: const InputDecoration(
                            label: Text("Confirm new e-mail")),
                ...
                MaterialButton(
                    ...
                    onPressed: () {
                      if (editEmailFormKey.currentState!.validate()) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(
                                "Updated e-mail to \"${emailController.text}\"")));
                      }
                    })
              ]);
        });
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                          ...
                          validator: (String? value) {
                            return (currentPassword.text != data['password'])
                                ? "Incorrect password"
                                : null;
                          }),
                      TextFormField(
                      ...
                      TextFormField(
                          ...
                          validator: (String? value) {
                            return (newPassword.text != confirmNewPassword.text)
  ...
  Widget build(BuildContext buildContext) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            backgroundColor: AppStyles.primaryColor(isDarkMode)
                .withOpacity(isDarkMode ? 0.5 : 1.0)),
          ...
          child: Stack(
            children: [
              Container(
                  ...
                  color: isDarkMode
                      ? Colors.transparent
                      : AppStyles.primaryColor(isDarkMode).withOpacity(0.2)),
              FutureBuilder(
                  future: SharedPreferences.getInstance(),
                  builder: (BuildContext context0,
                      AsyncSnapshot<SharedPreferences> snapshot0) {
                      ...
                      return FutureBuilder(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.hasError) {
                              return Center(
                                  child: Text("Something went wrong!",
                                      style: AppStyles.getSubHeadingStyle(
                                          darkmode)));
                            }
                            ...
                            return Center(
                              ...
                              children: [
                                Text("Loading @$username's Info",
                                    style: TextStyle(
                                        fontFamily: 'Geologica',
                                        fontSize: 18,
                                        fontWeight: FontWeight.w800,
                                        color:
                                            AppStyles.accentColor(isDarkMode))),
